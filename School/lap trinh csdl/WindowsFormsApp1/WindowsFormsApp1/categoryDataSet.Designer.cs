...
namespace WindowsFormsApp1 {
    ...
    public partial class categoryDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoryRow AddCategoryRow(int ID, string CategoryName, string Description, byte[] Picture) {
...
namespace WindowsFormsApp1.categoryDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Category] WHERE (([ID] = @Original_ID) AND ((@IsNull_CategoryName = 1 AND [CategoryName] IS NULL) OR ([CategoryName] = @Original_CategoryName)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([ID], [CategoryName], [Description], [Picture]) VAL" +
                "UES (@ID, @CategoryName, @Description, @Picture);\r\nSELECT ID, CategoryName, Desc" +
                "ription, Picture FROM Category WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Category] SET [ID] = @ID, [CategoryName] = @CategoryName, [Description] = @Description, [Picture] = @Picture WHERE (([ID] = @Original_ID) AND ((@IsNull_CategoryName = 1 AND [CategoryName] IS NULL) OR ([CategoryName] = @Original_CategoryName)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT ID, CategoryName, Description, Picture FROM Category WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, CategoryName, Description, Picture FROM dbo.Category";
        ...
        public virtual int Insert(int ID, string CategoryName, string Description, byte[] Picture) {
        ...
        public virtual int Update(int ID, string CategoryName, string Description, byte[] Picture, int Original_ID, string Original_CategoryName, string Original_Description) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CategoryName, string Description, byte[] Picture, int Original_ID, string Original_CategoryName, string Original_Description) {
            return this.Update(Original_ID, CategoryName, Description, Picture, Original_ID, Original_CategoryName, Original_Description);
        }
    }
