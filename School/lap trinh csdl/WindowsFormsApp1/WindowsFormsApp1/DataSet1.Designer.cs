...
namespace WindowsFormsApp1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoryRow AddCategoryRow(int Expr1, string CategoryName, string Description, byte[] Picture) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoryRow FindByExpr1(int Expr1) {
        ...
        public partial class CategoryRow : global::System.Data.DataRow {
            ...
            public int Expr1 {
                get {
                    return ((int)(this[this.tableCategory.Expr1Column]));
                }
                set {
...
namespace WindowsFormsApp1.DataSet1TableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Category] WHERE (([ID] = @Original_Expr1) AND ((@IsNull_CategoryName = 1 AND [CategoryName] IS NULL) OR ([CategoryName] = @Original_CategoryName)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Category] ([ID], [CategoryName], [Description], [Picture]) VALUES (@" +
                "Expr1, @CategoryName, @Description, @Picture);\r\nSELECT ID AS Expr1, CategoryName" +
                ", Description, Picture FROM Category WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Category] SET [ID] = @Expr1, [CategoryName] = @CategoryName, [Description] = @Description, [Picture] = @Picture WHERE (([ID] = @Original_Expr1) AND ((@IsNull_CategoryName = 1 AND [CategoryName] IS NULL) OR ([CategoryName] = @Original_CategoryName)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT ID AS Expr1, CategoryName, Description, Picture FROM Category WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.categoryConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT    ID AS Expr1, CategoryName, Description, Picture\r\nFROM         Category";
        ...
        public virtual int Delete(int Original_Expr1, string Original_CategoryName, string Original_Description) {
        ...
        public virtual int Insert(int Expr1, string CategoryName, string Description, byte[] Picture, int ID) {
        ...
        public virtual int Update(int Expr1, string CategoryName, string Description, byte[] Picture, int Original_Expr1, string Original_CategoryName, string Original_Description, int ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CategoryName, string Description, byte[] Picture, int Original_Expr1, string Original_CategoryName, string Original_Description) {
            return this.Update(Original_Expr1, CategoryName, Description, Picture, Original_Expr1, Original_CategoryName, Original_Description, Original_Expr1);
        }
    }
